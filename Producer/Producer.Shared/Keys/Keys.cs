namespace Producer
{
    public static partial class Keys
    {
        ...
        {
#if DEBUG
            //public const string ServiceUrl = @"<LOCAL-IP-FOR-DEBUG>";
            public const string ServiceUrl = @"https://<APP-SERVICE>.azurewebsites.net/";
#else
            public const string ServiceUrl = @"https://<APP-SERVICE>.azurewebsites.net/";
#endif
            ...
            public static partial class Storage
            {
                ...
                public const string BaseUrl = @"https://<APP-SERVICE>.blob.core.windows.net";
            }
        }
    }
}
